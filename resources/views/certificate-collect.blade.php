...
<head>
    ...
    <title>เกียรติบัตรที่ได้รับ</title>
...
<body class="grad">
    ...
    <div class="container mt-4">
        @foreach ($listcer as $certificate)
            <div class="card mx-auto mb-4" style="width: 20rem;">
                <div class="card-body ">
                    <h5 class="card-title font-strong">{{ $certificate['name'] }}</h5>
                    <button type="submit" class="btn btn-primary mt-2 download">ดาว์โหลดเกียรติบัตร</button>
                    <span class="float-end circle">
                        {{ $certificate['point'] }} p
                    </span>
